...
export default function NewClientPage() {
  return (
    <Shell title="新增客户 / Novo cliente">
      <EntityCreateForm
        endpoint="/clients"
        redirectTo="/clients"
        fields={[
          { name: "client_type", label: "客户类型 / Tipo de cliente", type: "select", defaultValue: "company", options: [{ value: "company", label: "企业 / Empresa" }, { value: "individual", label: "个人 / Pessoa física" }], required: true },
          ...
          { name: "status", label: "状态 / Status", type: "select", defaultValue: "lead", options: [{ value: "lead", label: "潜在 / Lead" }, { value: "active", label: "活跃 / Ativo" }, { value: "inactive", label: "暂停 / Inativo" }, { value: "lost", label: "流失 / Perdido" }], required: true },
