    ...
    <Shell title="渠道商详情 / Detalhes do parceiro de canal">
      <div className="stack">
        <div className="toolbar-right">
          ...
          <DeleteButton endpoint={`/channel-partners/${id}`} label="删除渠道 / Excluir" confirmMessage="确认删除这个渠道伙伴吗？ / Confirmar exclusão deste parceiro de canal?" redirectTo="/partners" />
        </div>
        <EntityDetail endpoint={`/channel-partners/${id}`} fields={[
